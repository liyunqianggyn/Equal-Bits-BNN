...
def parse_arguments():
    ...
    parser.add_argument('--seed', '--seed', default=10, type=float,
                        metavar='SD', help='set a seed')
    ...
    parser.add_argument(
        "--binarization-mode", default="halfmask", help="optional binarization modes are {sign, half, halfmask, mask}"
    )
    parser.add_argument(
